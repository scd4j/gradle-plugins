...
public class AlertMessageDialog {
	...
	public AlertMessageDialog(String version, String packName,
		...
		String production = env.getProductionIps().toString();
		String staging = env.getStagingIps().toString();
		String testing = env.getTestingIps().toString();
	...
	private void buildEnvironmentPanel(String production, String staging, String testing) {
		JPanel environment = new JPanel();
		environment.setBorder(BorderFactory.createTitledBorder("Environment Configuration"));
